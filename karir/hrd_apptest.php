...
/*
    Konfigurasi untuk menyimpan gambar yang diupload ke DB
    exec: "ALTER TABLE  `application` ADD  `app_picture` TEXT NOT NULL AFTER  `app_hobby`" 
    terlebih dahulu
    ---- START HERE ---
*/
    $maxFileSize            = 5;                   /* ukuran dalam MB */
    $upload['saveTo']       = "uploaded/";       /* lokasi penyimpanan gambar yg diupload */
    $upload['imageType']    = array(".jpg", ".jpeg", ".png"); /* extensi yang diperbolehkan */
    $upload['maxImageSize'] = $maxFileSize * 100000;   /* ukuran * 1MB */

/*
    ---- END HERE ---
    Konfigurasi untuk gambar yang diupload

    fixed by: damnyousemicolon @ yahoo.com
*/
...
<title>ANTV | KARIR - Form Aplikasi</title>
<style type="text/css">
<!--
body {
	margin-top: 0px;
...
<body background="../inc/BGpage.png">
  ...
  <?php
  	   if(isset($_POST['register']))
	   {
 		    ...
 		    )
            {
                ...
                {
                    if ( $_FILES['photo']['size'] > $upload['maxImageSize'] ) {
                        $valid_file = FALSE;
                        $error = "Ukuran File Tidak Boleh Lebih Dari 100 KB".$maxFileSize." MB";
                    }
                    
                    $extensi = strtolower(substr($_FILES['photo']['name'], -4));
                    if ( ! in_array($extensi, $upload['imageType']) ) {
                        $valid_file = FALSE;
                    }


                    if ( $valid_file ) {
                        $filename = strtolower( preg_replace("/[^a-zA-Z]+/", "", $_POST['username']) );
                        $filepath = $upload['saveTo'].$filename.$extensi;
                ...
                {
                    $error = "Gagal Mengunggah Foto".$_FILES['photo']['error'];
                }
                ...
                VALUES (
                    ...
                    '".mysql_real_escape_string($_POST['s1_major'])."',
                    ...
                    '".mysql_real_escape_string($_POST['s2_major'])."',
                    ...
                    '".mysql_real_escape_string($_POST['w1_year'])."',
                    '".mysql_real_escape_string($_POST['w2_year'])."',
                    ...
                    '".mysql_real_escape_string($_POST['w3_year'])."',
                    '".mysql_real_escape_string($_POST['w4_year'])."',
                    ...
                    '".mysql_real_escape_string($_POST['w5_year'])."',
                    '".mysql_real_escape_string($_POST['w6_year'])."',
                    '".mysql_real_escape_string($_POST['work3_brief'])."',

                    '".mysql_real_escape_string($_POST['sk1'])."',
                    '".mysql_real_escape_string($_POST['sk2'])."',
                    '".mysql_real_escape_string($_POST['sk3'])."',
                    '".mysql_real_escape_string($_POST['sk4'])."',
                ...
                if ( $query ) {
                    ...
                    // rename gambarnya jadi "nama_app_id"
                    $newfilepath = $upload['saveTo'].$filename."_".$app_id.$extensi;
                    rename($filepath, $newfilepath);
                    // taruh redirect disini
					/*echo '<script language="javascript">alert("Data uploaded succesfully!");</script>';*/
...
?>
  ...
  <center>
            <span class="NormalText_Bold"><?php echo $error; ?></span>
        </center>
        <div align="center">
<?php
    }
...
?>
            <p align="center">
            <span class="FontKecil_Bold">Field dengan tanda (*) wajib diisi</span></p>
      </div>
	  <form action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data" name="applicant">
  ...
  <table width="560" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr class="FontItem_Normal">
      ...
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><select name="division" id="division" size="1" class="ip1"><br />
<?php
    do {
?>
        <option value="<?php echo $row_RS_Division['div_name']?>"<?php if(isset($_POST['division']) == $row_RS_Division['div_name']) { echo ' selected="selected"'; } ?>>
            <?php echo $row_RS_Division['div_name']?>
        </option>
<?php
...
<?php
    do {
?>
        <option value="<?php echo $row_RS_Sex['sex_type']?>"<?php if(isset($_POST['sex']) == $row_RS_Sex['sex_type']) { echo ' selected="selected"';} ?>>
            <?php echo $row_RS_Sex['sex_type']?>
        </option>
<?php
...
?>
        <option
            value="<?php echo $row_RS_Married['married_type']?>"
            <?php if(isset($_POST['married']) == $row_RS_Married['married_type']) { echo 'selected="selected"';} ?>
        >
            <?php echo $row_RS_Married['married_type']?>
        </option>
<?php
...
?>
        <option
            value="<?php echo $row_RS_dd['dd_desc']?>"
            <?php if(isset($_POST['dob_dd']) == $row_RS_dd['dd_desc']) { echo 'selected="selected"';} ?>
		>
            <?php echo $row_RS_dd['dd_desc']?>
        </option>
<?php
...
?>
          <option 
                value="<?php echo $row_RS_mm['mm_desc']?>"
		        <?php if(isset($_POST['dob_mm']) == $row_RS_mm['mm_desc']) { echo 'selected="selected"';} ?>
		  >
            <?php echo $row_RS_mm['mm_desc']?>
          </option>
          <?php
...
?>
		  ...
		  <?php if(isset($_POST['dob_yyyy']) == $row_RS_yyyy['yy_desc']) { echo 'selected="selected"';} ?>
...
?>
        <option value="<?php echo $row_RS_Location['loc_area']?>"
		  <?php if(isset($_POST['location']) == $row_RS_Location['loc_area']) { echo 'selected="selected"';} ?>
...
?>
        <option value="<?php echo $row_RS_Province['prov_area']?>"
		  <?php if(isset($_POST['province']) == $row_RS_Province['prov_area']) { echo 'selected="selected"';} ?>
...
?>
        <option value="<?php echo $row_RS_EduType['edu_desc']?>"
		  <?php if(isset($_POST['s1_edutype']) == $row_RS_EduType['edu_desc']) { echo 'selected="selected"';} ?>
...
?>
    ...
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">Konsentrasi / Major <span class="FontKecil_Bold">(*)</span></td>
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><input name="s1_major" id="s1_major" class="ip1" size="50" maxlength="100" value="<?php if(isset($_POST['s1_major'])){ echo $_POST['s1_major'];} ?>" /></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
...
?>
        <option value="<?php echo $row_RS_YearStudy['y1_desc']?>"
		  <?php if(isset($_POST['s1_year']) == $row_RS_YearStudy['y1_desc']) { echo 'selected="selected"';} ?>
...
?>
        <option value="<?php echo $row_RS_EduType['edu_desc']?>"
		  <?php if(isset($_POST['s2_edutype']) == $row_RS_EduType['edu_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_EduType['edu_desc']?></option>
        <?php
} while ($row_RS_EduType = mysql_fetch_assoc($RS_EduType));
?>
    ...
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">Konsentrasi / Major <span class="FontKecil_Bold">(*)</span></td>
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><input name="s2_major" id="s2_major" class="ip1" size="50" maxlength="100" value="<?php if(isset($_POST['s2_major'])){ echo $_POST['s2_major'];} ?>" /></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
...
?>
        <option value="<?php echo $row_RS_YearStudy['y1_desc']?>"
		  <?php if(isset($_POST['s2_year']) == $row_RS_YearStudy['y1_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_YearStudy['y1_desc']?></option>
        <?php
} while ($row_RS_YearStudy = mysql_fetch_assoc($RS_YearStudy));
  $rows = mysql_num_rows($RS_YearStudy);
...
?>
        <option value="<?php echo $row_RS_YearWork['y2_desc']?>"
		  <?php if(isset($_POST['w1_year']) == $row_RS_YearWork['y2_desc']) { echo 'selected="selected"';} ?>
...
?>
        <option value="<?php echo $row_RS_YearWork['y2_desc']?>"
		  <?php if(isset($_POST['w2_year']) == $row_RS_YearWork['y2_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_YearWork['y2_desc']?></option>
        <?php
} while ($row_RS_YearWork = mysql_fetch_assoc($RS_YearWork));
  $rows = mysql_num_rows($RS_YearWork);
...
?>
    ...
    <tr class="FontItem_Normal">
      ...
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="work1_brief" id="work1_brief" cols="39" rows="3" class="ip1" ><?php if(isset($_POST['work1_brief'])){ echo $_POST['work1_brief'];} ?></textarea></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
...
?>
        <option value="<?php echo $row_RS_YearWork['y2_desc']?>"
		  <?php if(isset($_POST['w3_year']) == $row_RS_YearWork['y2_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_YearWork['y2_desc']?></option>
        <?php
} while ($row_RS_YearWork = mysql_fetch_assoc($RS_YearWork));
  $rows = mysql_num_rows($RS_YearWork);
...
?>
        <option value="<?php echo $row_RS_YearWork['y2_desc']?>"
		  <?php if(isset($_POST['w4_year']) == $row_RS_YearWork['y2_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_YearWork['y2_desc']?></option>
        <?php
} while ($row_RS_YearWork = mysql_fetch_assoc($RS_YearWork));
  $rows = mysql_num_rows($RS_YearWork);
...
?>
    ...
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">Deskripsi Pekerjaan</td>
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="work2_brief" id="work2_brief" cols="39" rows="3" class="ip1" ><?php if(isset($_POST['work2_brief'])){ echo $_POST['work2_brief'];} ?></textarea></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
...
?>
        <option value="<?php echo $row_RS_YearWork['y2_desc']?>"
		  <?php if(isset($_POST['w5_year']) == $row_RS_YearWork['y2_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_YearWork['y2_desc']?></option>
        <?php
} while ($row_RS_YearWork = mysql_fetch_assoc($RS_YearWork));
  $rows = mysql_num_rows($RS_YearWork);
...
?>
        <option value="<?php echo $row_RS_YearWork['y2_desc']?>"
		  <?php if(isset($_POST['w6_year']) == $row_RS_YearWork['y2_desc']) { echo 'selected="selected"';} ?>
		  ><?php echo $row_RS_YearWork['y2_desc']?></option>
        <?php
} while ($row_RS_YearWork = mysql_fetch_assoc($RS_YearWork));
  $rows = mysql_num_rows($RS_YearWork);
...
?>
    ...
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">Deskripsi Pekerjaan</td>
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="work3_brief" id="work3_brief" cols="39" rows="3" class="ip1" ><?php if(isset($_POST['work3_brief'])){ echo $_POST['work3_brief'];} ?></textarea></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
    ...
    <tr class="FontItem_Normal">
      ...
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="sk1" id="sk1" cols="39" rows="10" class="ip1" ><?php if(isset($_POST['sk1'])){ echo $_POST['sk1'];} ?></textarea></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
    ...
    <tr class="FontItem_Normal">
      ...
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="sk2" id="sk2" cols="39" rows="10" class="ip1" ><?php if(isset($_POST['sk2'])){ echo $_POST['sk2'];} ?></textarea></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
    ...
    <tr class="FontItem_Normal">
      ...
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="sk3" id="sk3" cols="39" rows="10" class="ip1" ><?php if(isset($_POST['sk3'])){ echo $_POST['sk3'];} ?></textarea></td>
    </tr>
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
      <td align="center" valign="top" class="FontItem_Normal">&nbsp;</td>
    ...
    <tr class="FontItem_Normal">
      ...
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal"><textarea name="sk4" id="sk4" cols="39" rows="10" class="ip1" ><?php if(isset($_POST['sk4'])){ echo $_POST['sk4'];} ?></textarea></td>
    </tr>
    <!--- IMAGE UPLOAD FIELD -->
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">&nbsp;</td>
    ...
    <tr class="FontItem_Normal">
      <td valign="top" class="FontItem_Normal">Foto</td>
      <td align="center" valign="top" class="FontItem_Normal">:</td>
      <td valign="top" class="FontItem_Normal">
            <input type="file" name="photo" size="30" maxlength="50">
            Maks. 100KB     </td>
    </tr>
