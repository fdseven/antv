...
$schedule = $_POST['program'];
$date = $_POST['thn']. "-".$_POST['bln']. "-".$_POST['tgl']; // membentuk format thn-bln-tgl

$query = "INSERT INTO schedule (program, date, username) VALUES ('$schedule', '$date', '$username' )";
