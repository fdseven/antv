...
<html lang="en">
  ...
  <div id="overlay"></div>
	...
	<div id="main" class="container">
      ...
      <div id="header">
        <img class="cover" src="images/banner_kids_teen.jpg">
      </div>
      ...
      <div id="row_1" class="row">
        ...
        <div class="col-xs-12 col-sm-6 box">
          <div id="1" class="box_content row pview yellow">
            ...
            <img class="cover lazy" src="images/masha2.jpg">
        ...
        <div class="col-xs-6 col-sm-3 box">
          <div class="box_content">
          <img class="cover lazy" src="images/bean.jpg">
        ...
        <div class="col-xs-6 col-sm-3 box">
          <div class="box_content">
          <img class="cover lazy" src="images/tom_jerry.jpg">
        ...
        <div class="col-xs-6 col-sm-3 box">
          <div class="box_content">
          <img class="cover lazy" src="images/angry_birds.jpg">
        ...
        <div class="col-xs-6 col-sm-3 box">
          <div class="box_content">
          <img class="cover lazy" src="images/bimasakti.jpg">
        ...
        <div class="col-xs-12 col-sm-6 box pull-right">
          <div id="6" class="box_content row pview yellow">
            ...
            <img class="cover lazy" src="images/bernard_bear.jpg">
        ...
        <div class="col-xs-6 col-sm-3 box">
          <div class="box_content">
          <img class="cover lazy" src="images/curious_george.jpg">
